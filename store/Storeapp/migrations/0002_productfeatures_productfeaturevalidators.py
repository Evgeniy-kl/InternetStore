# Generated by Django 3.2.7 on 2021-09-04 20:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_measure', models.CharField(help_text='Единица измерения для конкретного фильтра. Например "Частота процессора (Ghz)."', max_length=50, verbose_name='Единица измерения для филтра')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('feature_value', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Значение характеристики')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Storeapp.category', verbose_name='Категория')),
                ('feature', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Storeapp.productfeatures', verbose_name='Характеристика')),
            ],
        ),
    ]
